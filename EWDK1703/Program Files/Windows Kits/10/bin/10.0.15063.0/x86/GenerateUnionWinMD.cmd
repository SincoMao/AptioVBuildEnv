...
set MDFolder=%temp%\StandaloneSDK\UnionWinmdWorkingFolder
...
"%lcltoolFolder%\MDMerge.exe" -n:1 -v -i "%lclWinMDFolder%\WinMDs" -o "%lclUMDFolder%" >> "%lclLogFileName%" 2>>"%lclErrFilename%"
